...
//        QVector4D QuadVertexPositions[4];

//        Render2D::Statistics Stats;

//        struct CameraData
//        {
//            QVector4D ViewProjection;
//        };
...
////    void Render2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor, const glm::vec4& tintColor)
////    {
////        DrawQuad({ position.x, position.y, 0.0f }, size, texture, tilingFactor, tintColor);
////    }

////    void Render2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor, const glm::vec4& tintColor)
////    {
////        HZ_PROFILE_FUNCTION();
...
////    void Render2D::DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, float tilingFactor, const glm::vec4& tintColor, int entityID)
////    {
////        HZ_PROFILE_FUNCTION();
...
////    void Render2D::DrawCircle(const glm::mat4& transform, const glm::vec4& color, float thickness /*= 1.0f*/, float fade /*= 0.005f*/, int entityID /*= -1*/)
////    {
////        HZ_PROFILE_FUNCTION();
...
////    void Render2D::DrawLine(const glm::vec3& p0, glm::vec3& p1, const glm::vec4& color, int entityID)
////    {
...
//    void Render2D::DrawString(const std::string& string, Ref<MyFonts> font, const QMatrix4x4& transform, const TextParams& textParams, int entityID)
//    {
...
//            // render here
//            s_Data.TextVertexBufferPtr->Position = transform * QVector4D(quadMin, 0.0f, 1.0f);
//            s_Data.TextVertexBufferPtr->Color = textParams.Color;
//            s_Data.TextVertexBufferPtr->TexCoord = texCoordMin;
//            s_Data.TextVertexBufferPtr->EntityID = entityID;
//            s_Data.TextVertexBufferPtr++;

//            s_Data.TextVertexBufferPtr->Position = transform * QVector4D (quadMin.x(), quadMax.y(), 0.0f, 1.0f);
//            s_Data.TextVertexBufferPtr->Color = textParams.Color;
//            s_Data.TextVertexBufferPtr->TexCoord = { texCoordMin.x(), texCoordMax.y()};
//            s_Data.TextVertexBufferPtr->EntityID = entityID;
//            s_Data.TextVertexBufferPtr++;

//            s_Data.TextVertexBufferPtr->Position = transform * QVector4D(quadMax, 0.0f, 1.0f);
//            s_Data.TextVertexBufferPtr->Color = textParams.Color;
//            s_Data.TextVertexBufferPtr->TexCoord = texCoordMax;
//            s_Data.TextVertexBufferPtr->EntityID = entityID;
//            s_Data.TextVertexBufferPtr++;

//            s_Data.TextVertexBufferPtr->Position = transform * QVector4D(quadMax.x(), quadMin.y(), 0.0f, 1.0f);
//            s_Data.TextVertexBufferPtr->Color = textParams.Color;
...
//    void Render2D::DrawString(const std::string& string, const QMatrix4x4& transform, const TextComponent& component, int entityID)
//    {
